  ...
  <div class="donationChar">
    ...
    <?php
        ...
        if(!$conn){
          ...
          $stid2 = oci_parse($conn, "SELECT TRUNC(AVG(AMOUNT), 3) FROM DONATE");
          ...
          echo "<p>How much money do we get from donation: </p><p>".$row2['TRUNC(AVG(AMOUNT),3)']."</p>";
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
  ...
  if(!empty($nickname) && !empty($cardNumber) && !empty($amount)){
    echo nl2br("<p class='error2'>Thanks for your donation! \n Statistics will be updated soon</p>");
  }
  ...
  $stid = oci_parse($conn, "INSERT INTO DONATE (DONATEID, AMOUNT, CARDNUMBER, NICKNAME) VALUES (DONATION_ID_SEQ.nextval, $amount, '$cardNumber', '$nickname')");
